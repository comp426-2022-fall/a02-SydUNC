...
if (process.argv.indexOf('-z') > -1) {
	timezone = moment.tz(argv[process.argv.indexOf('-z') - 1]);
}
var latitude = 0;
var longitude = 0;
console.log(argv);
...
// Fetch URL
const response = await fetch('https://api.open-meteo.com/v1/forecast?latitude='+latitude+'&longitude='+longitude+'&daily=precipitation_hours&timezone=auto');
